    ...
    <nav className="fixed top-0 z-50 w-full bg-bg-dark/80 backdrop-blur-xl border-b border-white/10 transition-all">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 md:h-24 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-tr from-[#ff6b00] to-[#ffaa00] rounded-xl flex items-center justify-center shadow-[0_0_15px_rgba(255,107,0,0.4)] group-hover:shadow-[0_0_20px_rgba(255,107,0,0.6)] group-hover:rotate-6 transition-all duration-500">
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-10">
          ...
          <a href="#reviews" className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/50 hover:text-white transition-all relative group">
            {t('reviews')}
            <span className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-0 h-px bg-white transition-all duration-300 group-hover:w-full" />
          </a>
          <a href="#events" className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/50 hover:text-white transition-all relative group">
            {t('events')}
            <span className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-0 h-px bg-white transition-all duration-300 group-hover:w-full" />
          </a>
